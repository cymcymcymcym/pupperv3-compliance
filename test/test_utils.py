...
def test_relu():
    ...
    input_val = jp.array([-1.0, 0.0, 1.0], dtype=jp.float32)
    expected_output = jp.array([0.0, 0.0, 1.0], dtype=jp.float32)
...
def test_softmax():
    ...
    input_val = jp.array([1.0, 2.0, 3.0], dtype=jp.float32)
...
def test_circular_buffer_push_back():
    buffer = jp.array([[1, 2, 3], [4, 5, 6]], dtype=jp.float32)
    new_value = jp.array([7, 8], dtype=jp.float32)
    expected_output = jp.array([[2, 3, 7], [5, 6, 8]], dtype=jp.float32)
...
def test_circular_buffer_push_front():
    buffer = jp.array([[1, 2, 3], [4, 5, 6]], dtype=jp.float32)
    new_value = jp.array([7, 8], dtype=jp.float32)
    expected_output = jp.array([[7, 1, 2], [8, 4, 5]], dtype=jp.float32)
